...
description: How to architect AI/LLM PRODUCTS, not just call a model. Use when
  building agents, RAG, memory hierarchies, tool calling, MCP, model routing,
  prompt caching, guardrails, evaluation, sandboxing, human-in-the-loop, AI
  observability.
license: MIT
