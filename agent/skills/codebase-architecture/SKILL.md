...
description: How to organize CODE by business domain, not framework. Use when
  structuring folders/modules, monorepos, layered dependencies, module
  independence, code hygiene, detecting architecture smells, and refactoring.
license: MIT
