...
description: How to design APIs around BUSINESS DOMAINS, not database tables.
  Use when designing REST/GraphQL/gRPC/WebSocket endpoints, commands vs
  resources, auth, validation, idempotency, pagination, versioning, error
  contracts, caching, rate limits.
license: MIT
