...
description: Core engineering mindset for ANY system design or coding task. Use
  when about to write or scaffold code, choose a stack, or make an architecture
  decision — enforces a requirements-first thinking pipeline, golden rules,
  engineering laws, and mandatory pre-build questions.
license: MIT
