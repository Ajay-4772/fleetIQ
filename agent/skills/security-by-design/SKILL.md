...
description: How to make security an architectural PROPERTY. Use for auth,
  authorization, secrets, encryption, injection/XSS/CSRF/SSRF, rate limiting,
  multi-tenancy isolation, AI/prompt-injection security, compliance, audit logs,
  security review.
license: MIT
