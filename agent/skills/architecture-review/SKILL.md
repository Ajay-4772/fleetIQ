...
description: Mandatory PRE-MERGE architecture review. Use before approving or
  merging any code — run the review dimensions and merge scorecard to challenge
  design, catch coupling/security/scalability/cost issues, and verify production
  readiness.
license: MIT
