...
description: How to build systems that survive PRODUCTION. Use when designing
  horizontal scaling, statelessness, caching, queues, event-driven architecture,
  CQRS, sagas, outbox, circuit breakers, bulkheads, graceful degradation,
  multi-region, zero-downtime deploys.
license: MIT
