...
description: How to decide architecture and technology from REQUIREMENTS, not
  trends. Use when choosing between modular monolith vs microservices, SQL vs
  NoSQL, serverless vs containers, queues vs workflows, or evaluating trade-offs
