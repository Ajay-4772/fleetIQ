...
- **Roadmap Item:** Company must provision an enterprise LLM key and set `vehyron.jev.enabled=true`.
...
- **Roadmap Item:** Deploy Redis cluster and enable `vehyron.clustering.redis-enabled=true`.
